define(function(require) {
    ...
    domReady(function() {
        ...
        $("#gui_toggle_link").live('click', function() {
            if (gui_state) {
                $("#gui_toggle").html('<a href="javascript:;" id="gui_toggle_link"><i class="icon-white icon-eye-open"></i></a>');
                $("#body_container").fadeOut();
                gui_state = false;
            } else {
                $("#gui_toggle").html('<a href="javascript:;" id="gui_toggle_link"><i class="icon-white icon-eye-close"></i></a>');
