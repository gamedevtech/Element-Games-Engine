...
namespace EG{
    namespace Game{
        ...
        class ObjectAttributeBasicEntity : public ObjectAttribute {
            public:
                ObjectAttributeBasicEntity(EG::Game::Entity *_entity);
                ~ObjectAttributeBasicEntity(void);

                EG::Game::Entity *GetEntity(void);
                void SetEntity(EG::Game::Entity *_entity);
            private:
                EG::Game::Entity *entity;
        };
    }
}
