...
namespace EG{
    namespace Game{
        ...
        ObjectAttributeBasicEntity::ObjectAttributeBasicEntity(EG::Game::Entity *_entity) {
            type = EG::Game::ObjectAttribute::OBJECT_ATTRIBUTE_BASIC_ENTITY;
            entity = _entity;
        }

        ObjectAttributeBasicEntity::~ObjectAttributeBasicEntity(void) {
            //
        }

        EG::Game::Entity *ObjectAttributeBasicEntity::GetEntity(void) {
            return entity;
        }

        void ObjectAttributeBasicEntity::SetEntity(EG::Game::Entity *_entity) {
            entity = _entity;
        }
    }
}
