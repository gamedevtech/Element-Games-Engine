    ...
    namespace Media{
        class SFMLInterface{
            ...
            private:
                ...
                std::unordered_map<sf::Keyboard::Key, EG::Input::Key, std::hash<unsigned int> > key_translations;
                std::unordered_map<sf::Mouse::Button, EG::Input::Mouse, std::hash<unsigned int> > mouse_translations;
