...
namespace EG{
    namespace GUI{
        ...
        void GUI::InjectKeyPress(char key_code){
            ...
            keys[0] = key_code;
            keys[1] = '\0';
            wchar16 wkey_codes[2];
            awe_string *awe_key_codes = awe_string_create_from_ascii(keys, 2);
            awe_string_to_wide(awe_key_codes, wkey_codes, 2);
            key_event.text[0] = wkey_codes[0];
